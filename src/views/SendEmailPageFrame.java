...
public class SendEmailPageFrame extends javax.swing.JFrame {

    private DisplayThread displayThread;

    public SendEmailPageFrame() {
        setTitle("Send email");
        initComponents();
    ...
    private void sendMessage(String email, String subject, String content) {
        String mesaj = "SEND" + " " + email + " " + subject + " " + content;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        System.out.println("Clientul trimite catre server mesajul: " + mesaj);

        // dupa ce trimit vreau sa verific ca a fost cu success
//        while(true) {
//            String receiveMessage = ConnectionController.getInstance().receiveMessage();
//            jLabel4.setText(receiveMessage);
//            break;
//        }
...
//        System.out.println(receiveMessage);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        mainFrame.startDisplayThread();//AICI NU SUNT FOARTE SIGUR !!
